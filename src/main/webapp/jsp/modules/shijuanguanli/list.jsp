...
<body class="materialdesign">
							...
							<div class="sparkline13-list shadow-reset">
								<div class="sparkline13-hd">
									<div class="main-sparkline13-hd">
										<h1>
											试卷<span class="table-project-n">列表</span>
										</h1>
								...
								<div class="sparkline13-graph">
									<div class="datatable-dashv1-list custom-datatable-overright">
										<label>试卷</label> <input type="text" id="shijuanSearch">
										<button type="button"
										...
										<table id="table" data-toggle="table" data-resizable="true">
											<thead>
												<tr>
													...
													<th><i id="shijuanIcon" onclick="sort('shijuan')"
														class="fa fa-sort" aria-hidden="true"></i>试卷</th>
													<th><i id="timeIcon"
														onclick="sort('time')" class="fa fa-sort"
														aria-hidden="true"></i>考试时长</th>
													<th><i id="statusIcon"
														onclick="sort('status')" class="fa fa-sort"
														aria-hidden="true"></i>试卷状态</th>
													<th>操作</th>
												</tr>
											</thead>
											<tbody>
	...
	<%@ include file="../../static/crossBtnControl.js"%>
		...
		function search() {
			...
			if ($('#shijuanSearch').val() != null
					&& $('#shijuanSearch').val() != '') {
				searchForm.shijuan = "%" + $('#shijuanSearch').val() + "%";
			}
			getDataList();
		}
		// 获取数据列表
		...
		function setDataRow(item) {
			...
			var shijuanCell = document.createElement('td');

			shijuanCell.innerHTML = item.shijuan;

			row.appendChild(shijuanCell);
			...
			if(item.status == 0){
				statusCell.innerHTML = "<button type=\"button\" class=\"btn btn-custon-four btn-default\" disabled>禁用</button>";
			}else if(item.status == 1){
				statusCell.innerHTML = "<button type=\"button\" class=\"btn btn-custon-four btn-success\" disabled>启用</button>";
			}
