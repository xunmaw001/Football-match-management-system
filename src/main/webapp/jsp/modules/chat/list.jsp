                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">在线客服管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>在线客服<span class="table-project-n">列表</span></h1>
                                                ...
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="useridIcon" onclick="sort('userid')" class="fa fa-sort" aria-hidden="true"></i>用户id</th>
																																																			<th><i id="adminidIcon" onclick="sort('adminid')" class="fa fa-sort" aria-hidden="true"></i>管理员id</th>
																																																																			<th>提问</th>
																																																																																	<th>回复</th>
