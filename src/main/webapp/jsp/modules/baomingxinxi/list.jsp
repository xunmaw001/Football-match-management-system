                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">报名信息管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>报名信息<span class="table-project-n">列表</span></h1>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="zhanghaoIcon" onclick="sort('zhanghao')" class="fa fa-sort" aria-hidden="true"></i>账号</th>
																																																			...
																																																			<th><i id="lianxishoujiIcon" onclick="sort('lianxishouji')" class="fa fa-sort" aria-hidden="true"></i>联系手机</th>
																																																																			<th>照片</th>
