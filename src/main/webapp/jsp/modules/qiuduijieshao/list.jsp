                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">球队介绍管理</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>球队介绍<span class="table-project-n">列表</span></h1>
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">       
                                                                                                                                                        <label>球队名称</label>
                                        <input type="text" id="qiuduimingchengSearch">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" onclick="chooseAll()"></th>
                                                																										<th><i id="qiuduimingchengIcon" onclick="sort('qiuduimingcheng')" class="fa fa-sort" aria-hidden="true"></i>球队名称</th>
																																																			<th><i id="qiuduijieshaoIcon" onclick="sort('qiuduijieshao')" class="fa fa-sort" aria-hidden="true"></i>球队介绍</th>
																																																																			<th>照片</th>
																																																			<th>
													操作
												</th>
    ...
    <script>
		...
		function setDataRow(item){
			...
			row.appendChild(checkbox);
            				...
            				var qiuduijieshaoCell  = document.createElement('td');
												  ...
												  //如果图文详情包含图片
				  if(item.qiuduijieshao && item.qiuduijieshao.indexOf('img') != -1){
					//暂时只考虑图片+文字 和 文字+图片的情况
					var beginIndex = item.qiuduijieshao.indexOf('<img');
					var endIndex = item.qiuduijieshao.indexOf('>');				
					qiuduijieshaoCell.innerHTML = item.qiuduijieshao.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
				  }else{
				  	 if(item.qiuduijieshao != null && item.qiuduijieshao != "" && item.qiuduijieshao.length >= 11){
				  		qiuduijieshaoCell.innerHTML = item.qiuduijieshao.substring(0, 10) + "..."; 
				  	}else{
				  		qiuduijieshaoCell.innerHTML = item.qiuduijieshao;
				 	}
				  }

                
													row.appendChild(qiuduijieshaoCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qiuduijieshao/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						alert('删除成功');
						getDataList();		
					}
		...
		function getSum(colName){
			http("qiuduijieshao" + colName,"GET",{
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"qiuduijieshao");
