...
<html>
	...
	<body>
		...
		<div id="tabbar" v-if="false" class="tabbar" :style='{"padding":"20px 0","boxShadow":"0 0 6px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#000","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' style="position: relative;z-index: 999;">
