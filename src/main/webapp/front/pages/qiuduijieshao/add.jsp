			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.qiuduimingcheng" type="text" name="qiuduimingcheng" id="qiuduimingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
		            		            		            		            		            		            		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<button type="button" class="layui-btn btn-theme" id="zhaopianUpload">
								<i class="layui-icon">&#xe67c;</i>上传照片
		            		            		            		            		            ...
		            		            		            		            		            <div class="layui-form-item" pane>
						<label class="layui-form-label">球队介绍：</label>
						<div class="layui-input-block">
							<textarea name="qiuduijieshao" id="qiuduijieshao">请输入球队介绍</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('qiuduijieshao' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
