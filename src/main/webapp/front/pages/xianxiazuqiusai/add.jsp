			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.tupian" type="text" name="tupian" id="tupian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            		            		            		            <div class="layui-form-item" pane>
						<label class="layui-form-label">比赛编号：</label>
						<div class="layui-input-block">
							<input v-model="detail.bisaibianhao" type="text" name="bisaibianhao" id="bisaibianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            		            		            		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.renshu" type="text" name="renshu" id="renshu" autocomplete="off" class="layui-input">
						</div>
					</div>
		            		            		            		            <div class="layui-form-item" pane>
						<label class="layui-form-label">人均费用：</label>
						<div class="layui-input-block">
							<input v-model="detail.renjunfeiyong" type="text" name="renjunfeiyong" id="renjunfeiyong" autocomplete="off" class="layui-input">
						</div>
					</div>
		            		            		            		            <div class="layui-form-item" pane>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					// 提交数据
					http.requestJson('xianxiazuqiusai' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
