		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.saishi" type="text" name="saishi" id="saishi" autocomplete="off" class="layui-input">
						</div>
					</div>
		            		            		            		            <div class="layui-form-item" pane>
						<label class="layui-form-label">比分：</label>
						<div class="layui-input-block">
							<input v-model="detail.bifen" type="text" name="bifen" id="bifen" autocomplete="off" class="layui-input">
						</div>
					</div>
		            		            		            		            		            		            		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="bisaishijian" id="bisaishijian" autocomplete="off" class="layui-input">
		            		            		            		            		            ...
		            		            		            		            		            <div class="layui-form-item" pane>
						<label class="layui-form-label">参赛球员：</label>
						<div class="layui-input-block">
							<textarea name="cansaiqiuyuan" id="cansaiqiuyuan">请输入参赛球员</textarea>
						</div>
					</div>
		            		            		            		            		            		            		            		            <div class="layui-form-item" pane>
						<label class="layui-form-label">比赛细节：</label>
						<div class="layui-input-block">
							<textarea name="bisaixijie" id="bisaixijie">请输入比赛细节</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					var cansaiqiuyuan = tinymce.get('#cansaiqiuyuan').getContent()
					data.cansaiqiuyuan = cansaiqiuyuan;
										                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var bisaixijie = tinymce.get('#bisaixijie').getContent()
					data.bisaixijie = bisaixijie;
					...
					// 提交数据
					http.requestJson('saishishengkuang' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
